...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, f as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, g as Certificate, l as lookupResultToBuffer, h as RequestStatusResponseStatus, U as UnknownError, i as RequestStatusDoneNoReplyErrorCode, k as RejectError, m as CertifiedRejectErrorCode, n as UNREACHABLE_ERROR, I as InputError, o as InvalidReadStateRequestErrorCode, p as ReadRequestType, q as Principal, s as IDL, t as MissingCanisterIdErrorCode, H as HttpAgent, v as encode, Q as QueryResponseStatus, w as UncertifiedRejectErrorCode, x as isV3ResponseBody, y as isV2ResponseBody, z as UncertifiedRejectUpdateErrorCode, A as UnexpectedErrorCode, B as decode, D as Subscribable, F as pendingThenable, G as resolveEnabled, J as shallowEqualObjects, K as resolveStaleTime, N as noop$1, O as environmentManager, V as isValidTimeout, W as timeUntilStale, X as timeoutManager, Y as focusManager, Z as fetchState, _ as replaceData, $ as notifyManager, r as reactExports, a0 as shouldThrowError, a1 as useQueryClient, a2 as useInternetIdentity, a3 as createActorWithConfig, a4 as Variant, a5 as Record, a6 as Vec, a7 as Service, a8 as Func, a9 as Opt, aa as Nat, ab as Null, ac as Text, j as jsxRuntimeExports } from "./index-BgsP59Y_.js";
...
function useCarImages() {
  const getImage = reactExports.useCallback((carId) => {
    const store = loadStore();
    return store[carId.toString()];
  }, []);
  const setImage = reactExports.useCallback((carId, base64) => {
    const store = loadStore();
    store[carId.toString()] = base64;
    saveStore(store);
  }, []);
  const removeImage = reactExports.useCallback((carId) => {
    const store = loadStore();
    delete store[carId.toString()];
    saveStore(store);
  }, []);
  const getAllImages = reactExports.useCallback(() => {
    return loadStore();
  }, []);
  return { getImage, setImage, removeImage, getAllImages };
}
const CarId = Nat;
const Country = Variant({
  "UK": Null,
  "USA": Null,
  "Luxury": Null,
  "Russia": Null,
...
Service({
  "getAllCars": Func([], [Vec(Car)], ["query"]),
  "getCarById": Func([CarId], [Opt(Car)], ["query"]),
  "getCarsByCountry": Func([Country], [Vec(Car)], ["query"])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const CarId2 = IDL2.Nat;
  const Country2 = IDL2.Variant({
    "UK": IDL2.Null,
    "USA": IDL2.Null,
    "Luxury": IDL2.Null,
    "Russia": IDL2.Null,
  ...
  const Car2 = IDL2.Record({
    "id": CarId2,
    "identifyingFeatures": IDL2.Vec(IDL2.Text),
    "nickname": IDL2.Text,
    "country": Country2,
    "name": IDL2.Text,
    "imagePrompt": IDL2.Text
  });
  return IDL2.Service({
    "getAllCars": IDL2.Func([], [IDL2.Vec(Car2)], ["query"]),
    "getCarById": IDL2.Func([CarId2], [IDL2.Opt(Car2)], ["query"]),
    "getCarsByCountry": IDL2.Func([Country2], [IDL2.Vec(Car2)], ["query"])
  });
};
class Backend {
...
function from_candid_Car_n2(_uploadFile, _downloadFile, value) {
  return from_candid_record_n3(_uploadFile, _downloadFile, value);
}
function from_candid_Country_n4(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n5(_uploadFile, _downloadFile, value) {
  return "UK" in value ? "UK" : "USA" in value ? "USA" : "Luxury" in value ? "Luxury" : "Russia" in value ? "Russia" : "Korea" in value ? "Korea" : "Electric" in value ? "Electric" : "Germany" in value ? "Germany" : "Japan" in value ? "Japan" : value;
}
...
function to_candid_Country_n7(_uploadFile, _downloadFile, value) {
...
const SEEDED_CARS = [
  // Japan — 12 cars
  {
    ...
    imagePrompt: "Simple colorful vector illustration of 2010 Toyota Prius 30, front 3/4 view, smooth egg-shaped hatchback, rounded triangular headlights, vertical taillights. White background, child-friendly flashcard style."
  },
  {
    id: 2n,
    ...
    imagePrompt: "Simple colorful vector illustration of 2016 Toyota Prius 40, front 3/4 view, sharp angular body, arrow-slit headlights, vertical DRL. White background, child-friendly flashcard style."
  },
  {
    id: 3n,
    ...
    imagePrompt: "Simple colorful vector illustration of 2020 Toyota Prius 50, front 3/4 view, low wide stance, tiny squinting headlights, full-width rear light bar. White background, child-friendly flashcard style."
  },
  {
    id: 4n,
    ...
    imagePrompt: "Simple colorful vector illustration of Toyota Prius Alpha MPV, front 3/4 view, taller boxier rear, small hump on back, same face as Prius 30 but taller roofline. White background, child-friendly flashcard style."
  },
  {
    id: 5n,
    name: "Toyota Aqua",
    ...
    imagePrompt: "Simple colorful vector illustration of Toyota Aqua small hybrid hatchback, front 3/4 view, compact round body, 5 doors, friendly small face. White background, child-friendly flashcard style."
  },
  {
    id: 6n,
    ...
    imagePrompt: "Simple colorful vector illustration of 2004 Toyota Land Cruiser 100 SUV, front 3/4 view, large rounded body, big rectangular glass headlights, solid bumper. White background, child-friendly flashcard style."
  },
  {
    id: 7n,
    ...
    imagePrompt: "Simple colorful vector illustration of 2015 Toyota Land Cruiser 200 SUV, front 3/4 view, massive boxy body, headlights stretching upward, large chrome grille bars. White background, child-friendly flashcard style."
  },
  {
    id: 8n,
    ...
    imagePrompt: "Simple colorful vector illustration of 2022 Toyota Land Cruiser 300 SUV, front 3/4 view, enormous rectangular grille like huge mouth, small squarish headlights, sharp lines. White background, child-friendly flashcard style."
  },
  {
    id: 9n,
    name: "Toyota Corolla",
    ...
    imagePrompt: "Simple colorful vector illustration of 2020 Toyota Corolla sedan, front 3/4 view, long sleek low body, aggressive sharp grille and headlights. White background, child-friendly flashcard style."
  },
  {
    id: 10n,
    name: "Toyota Camry",
    ...
    imagePrompt: "Simple colorful vector illustration of 2021 Toyota Camry sedan, front 3/4 view, very wide lower grille like large mouth, sleek headlights, low wide stance. White background, child-friendly flashcard style."
  },
  {
    id: 11n,
    name: "Toyota Harrier",
    ...
    imagePrompt: "Simple colorful vector illustration of 2020 Toyota Harrier SUV, front 3/4 view, sharp pointed nose angled down, narrow upswept headlights, coupe-like roofline. White background, child-friendly flashcard style."
  },
  {
    id: 12n,
    name: "Toyota Vitz",
    ...
    imagePrompt: "Simple colorful vector illustration of 2010 Toyota Vitz hatchback, front 3/4 view, very small cute round body, big friendly teardrop headlights, round rear. White background, child-friendly flashcard style."
  },
  // Korea — 3 cars
  {
    id: 13n,
    ...
    imagePrompt: "Simple colorful vector illustration of Hyundai Porter small truck, front 3/4 view, flat cab nose, open cargo bed with low sides. White background, child-friendly flashcard style."
  },
  {
    id: 14n,
    ...
    imagePrompt: "Simple colorful vector illustration of Hyundai Grand Starex van, front 3/4 view, tall boxy shape, large windows all around, sliding side door. White background, child-friendly flashcard style."
  },
  {
    id: 15n,
    name: "Hyundai Tucson",
    ...
    imagePrompt: "Simple colorful vector illustration of modern Hyundai Tucson SUV, front 3/4 view, compact low body, sharp lines, cascading front grille with geometric pattern. White background, child-friendly flashcard style."
  },
  // Russia — 1 car
  {
    id: 16n,
    ...
    imagePrompt: "Simple colorful vector illustration of UAZ Patriot SUV, front 3/4 view, very boxy military-like shape, round headlights, heavy metal bumper, flat panels. White background, child-friendly flashcard style."
  },
  // Germany — 5 cars
  {
    id: 17n,
    ...
    imagePrompt: "Simple colorful vector illustration of 2020 Mercedes G-Class SUV, front 3/4 view, completely flat square body, round headlights, flat windshield. White background, child-friendly flashcard style."
  },
  {
    id: 18n,
    name: "BMW X5",
    ...
    imagePrompt: "Simple colorful vector illustration of 2020 BMW X5 SUV, front 3/4 view, large upright kidney grille, sleek headlights, large greenhouse windows. White background, child-friendly flashcard style."
  },
  {
    id: 19n,
    name: "BMW X6",
    ...
    imagePrompt: "Simple colorful vector illustration of 2020 BMW X6 coupe-SUV, front 3/4 view, same face as X5 but dramatically sloping roof at back, sporty silhouette. White background, child-friendly flashcard style."
  },
  {
    id: 20n,
    name: "Audi Q7",
    ...
    imagePrompt: "Simple colorful vector illustration of 2021 Audi Q7 SUV, front 3/4 view, large singleframe grille, sharp high-tech matrix headlights with distinct LED signature. White background, child-friendly flashcard style."
  },
  {
    id: 21n,
    ...
    imagePrompt: "Simple colorful vector illustration of 2021 VW Touareg SUV, front 3/4 view, wide plain horizontal lines, elegant grille with chrome bars, calm dignified face. White background, child-friendly flashcard style."
  },
  // UK — 2 cars
  {
    id: 22n,
    ...
    imagePrompt: "Simple colorful vector illustration of 2020 Range Rover SUV, front 3/4 view, flat floating roof design, RANGE ROVER lettering on grille, clamshell bonnet. White background, child-friendly flashcard style."
  },
  {
    id: 23n,
    ...
    imagePrompt: "Simple colorful vector illustration of 2020 Land Rover Defender SUV, front 3/4 view, boxy shape, round headlights on flat face, short overhangs. White background, child-friendly flashcard style."
  },
  // USA — 3 cars
  {
    id: 24n,
    ...
    imagePrompt: "Simple colorful vector illustration of Jeep Wrangler 4-door, front 3/4 view, flat body panels, round headlights, 7-slot grille. White background, child-friendly flashcard style."
  },
  {
    id: 25n,
    ...
    imagePrompt: "Simple colorful vector illustration of Ford Ranger Raptor pickup truck, front 3/4 view, huge FORD letter logo across black grille, wide flared fenders, high ground clearance. White background, child-friendly flashcard style."
  },
  {
    id: 26n,
    ...
    imagePrompt: "Simple colorful vector illustration of 2021 Chevrolet Tahoe large SUV, front 3/4 view, massive chrome split grille, boxy full-size body, strong horizontal lines. White background, child-friendly flashcard style."
  },
  // Luxury — 2 cars
  {
    id: 28n,
    ...
    imagePrompt: "Simple colorful vector illustration of 2020 Lexus LX 570 large luxury SUV, front 3/4 view, huge spindle grille shaped like hourglass, sharp triple-beam headlights, massive body. White background, child-friendly flashcard style."
  },
  {
    id: 29n,
    name: "Lexus GX 470",
    ...
    imagePrompt: "Simple colorful vector illustration of 2008 Lexus GX 470 SUV, front 3/4 view, smaller hourglass grille, rounder softer headlights than LX570, tall upright body. White background, child-friendly flashcard style."
  },
  // Electric — 1 car
  {
    id: 27n,
    ...
    imagePrompt: "Simple colorful vector illustration of BYD Han electric car, front 3/4 view, completely smooth closed-off front with no grille, sleek futuristic headlights, clean aerodynamic shape. White background, child-friendly flashcard style."
  }
];
function toFrontendCar(raw) {
  const country = Object.keys(raw.country)[0] ?? "Japan";
  return { ...raw, country };
}
function useAllCars() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        const result = await actor.getAllCars();
...
function useCarById(id2) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["car", id2.toString()],
    queryFn: async () => {
      if (!actor) return SEEDED_CARS.find((c) => c.id === id2) ?? null;
      try {
        const result = await actor.getCarById(id2);
        if (result && result.__kind__ === "Some") {
          return toFrontendCar(result.value);
        }
      } catch {
      }
      return SEEDED_CARS.find((c) => c.id === id2) ?? null;
    },
    enabled: !isFetching,
    staleTime: 1e3 * 60 * 5
  });
